 ...
 * @version 2019-12-13
 */
public class EducationProjectImplementationPlan extends DataEntity<EducationProjectImplementationPlan> {
	 ...
	 *  项目支出实施方案
	 */
	public EducationProjectImplementationPlan() {
		super();
	}
	 ...
	 * @param id
	 */
	public EducationProjectImplementationPlan(String id){
		super(id);
	}
