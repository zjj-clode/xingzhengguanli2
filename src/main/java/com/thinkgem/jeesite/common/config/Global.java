...
public class Global {
	...
	public static String getTemplatePath() {
		// 如果配置了工程路径，则直接返回，否则自动获取。
		String templatePath = Global.getConfig("templatePath");
	...
	public static boolean logEnable() {
		return Boolean.valueOf(getConfig("akmi.log.save"));
	}
}
