 ...
 * better integration with cut(1) and other Unix tools). Added some points to the
 * <a href="http://schmidt.devlib.org/image-info/index.html#knownissues">'Known issues' section of the website</a>.
 * Released as 1.6.</li>
 ...
 * on truncated data streams. Thanks to Martin Leidig for reporting this and sending in code. Released as 1.8.</li></li>
