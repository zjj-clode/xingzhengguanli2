...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @return 如果目录删除成功，则返回true，否则返回false
	 */
	public static boolean deleteFileByDirectory(String dirName) {
		String dirNames = dirName;
		if (!dirNames.endsWith(File.separator)) {
			dirNames = dirNames + File.separator;
		}
		...
		try {
			...
			if (file.isFile() && file.exists()) { //判断文件是否存在
				...
				while ((lineTxt = bufferedReader.readLine()) != null) {
					//log.debug("lineTxt={}", lineTxt);
					if (StringUtils.isNotBlank(lineTxt)) {
						listStr.add(lineTxt.trim());
					}
				}
				read.close();
				return listStr;
	 ...
	 * @param file
	 */
	public static void createRecurDirectory(File file) {
		...
		if (file.getParentFile().exists()) {
			...
			createRecurDirectory(file.getParentFile());
			if (!file.exists()) {
				file.mkdir();
			}
		}
	 ...
	 * 对文件进行md5校验
	 * 
	 * @return 07DD406A36AF0D481522E25D9FAE1002
	 */
	public static String checkMd5(File file) {
		return checkMessageDigest(file, "MD5");
	}

	/**
	 * 对文件进行sha1校验
	 * 
	 * @return 19B500B04A0C97A6B4D212FB62ED0759D0933CB1
	 */
	public static String checkSHA1(File file) {
		return checkMessageDigest(file, "SHA1");
	}

	private static String checkMessageDigest(File file, String algorithm) {
	 ...
	 * @return E5FBD006
	 */
	public static String checkCRC32(File file) {
	...
	public static void main(String[] args) throws Exception {
		//zipFiles("D:/keys", "", "D:/test参数.zip");
		System.out.println(checkMd5(new File("C:\\Users\\pc\\Videos\\1.mp4")));
		System.out.println(checkSHA1(new File("C:\\Users\\pc\\Videos\\1.mp4")));
		System.out.println(checkCRC32(new File("C:\\Users\\pc\\Videos\\1.mp4")));
	}
