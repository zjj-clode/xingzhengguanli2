 ...
 * @version 2013-05-15
 */
@JsonIgnoreProperties({ /*"id",*/ "isNewRecord", "createBy", "createDate", "updateBy", "updateDate", "site", "office", "customListView", "customContentView" })
public class Category extends TreeEntity<Category> {
	...
	public String getShowModesLabel() {
		return DictUtils.getDictLabel(showModes, "", showModes);
	}
