	...
	public String form(Role role, Model model) {
		...
		if(menuList != null && menuList.size() != 0){
			...
			for (Menu menu : menuList) {
				...
				jo.put("pId", (menu.getParent() != null && StringUtils.isNotBlank(menu.getParent().getId()))?menu.getParent().getId():"0");
				jo.put("name", (menu.getParent() != null && StringUtils.isNotBlank(menu.getParent().getId()))?menu.getName():"权限列表");
				
				ja.add(jo);
			}
			model.addAttribute("menuList", ja.toString());
		}
		...
		if(officeList != null && officeList.size() != 0){
			...
			for (Office office : officeList) {
				...
				jo.put("pId", (office.getParent() != null && StringUtils.isNotBlank(office.getParent().getId()))?office.getParent().getId():"0");
				jo.put("name", office.getName());
				
				ja.add(jo);
			}
			model.addAttribute("officeList", ja.toString());
		}
