...
<script src="${ctxStatic}/jquery/j1.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/main.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/tabswitch.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/common.js" type="text/javascript"></script>
<script type="text/javascript" src="${ctxStatic}/colorpicker/jquery.colorpicker.js"></script>
