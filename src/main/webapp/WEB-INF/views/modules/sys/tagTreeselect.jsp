...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:(type==5),url:"${ctx}/sys/user/treeData",autoParam:["id=officeId"]},
		...
		function selectCheckNode(){
			...
			for(var i=0; i<ids.length; i++) {
				var node = tree.getNodeByParam("id", (type==5?"u_":"")+ids[i]);
				if("${checked}" == "true"){
...
<div class="pad15">
  <div class="treeSearch">
    <div class="form-group">
      <label for="">关键词：</label>
      <input type="text" class="form-control" id="key" name="key" placeholder="请输入关键词搜索" style="width:150px">
      <button type="button" class="btn btn-default" title="" onclick="searchNode()" data-original-title="搜索" ><i class="fa fa-search"></i></button>
    </div>
  </div>
