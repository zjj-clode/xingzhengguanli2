...
<body>
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="${ctx}/qa/qaQuestion/list1">在线咨询管理</a></li>
	...
	<section class="content">
      <div class="row">
        <div class="col-md-12">
			<form:form id="inputForm" modelAttribute="qaQuestion" action="${ctx}/qa/qaQuestion/saveQuestion1" method="post" class="form-horizontal form-information pad form-lie">
				<form:hidden path="id"/>
				...
				<%--<div class="form-group">
					...
					<div class="col-sm-3">
						<form:select path="identify" class="form-control " disabled="true">
							<form:option value="" label="=== 请选择提问者身份 ==="/>
							<c:forEach items="${fns:getDictList('sys_user_type')}" var="userType">
								<option value="${userType.value}" <c:if test="${userType.value eq '2'}"> selected="selected" </c:if>>
									 ${userType.label}
								</option>
							</c:forEach>
						</form:select>
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">
					提问内容<span class="text-red fm">*</span>：</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<form:select path="isopen" class="form-control ">
							...
							<c:forEach items="${fns:getDictList('yes_no')}" var="status">
								<option value="${status.value}" <c:if test="${status.value eq '1'}"> selected="selected" </c:if>>
									 ${status.label}
								</option>
							</c:forEach>
						</form:select>
				...
				<%-- <div class="form-group">
					<label class="col-sm-1 control-label">		
					回复内容<span class="text-red fm">*</span>：</label>
					<div class="col-sm-3">
				...
				<div class="form-group" hidden="hidden">
					...
					问题创建方式：</label>
					<div class="col-sm-3">
						<form:input path="questioner"  htmlEscape="false" maxlength="20" class="form-control" disabled="true"/>
					</div>
				</div>
				<div class="form-group">
