...
<head>
	...
	<style type="text/css">
		...
		.ztree li a {width:180px;height:40px;padding-top: 0px;text-indent: 10px;}
		.ztree li a:hover {text-decoration:none; background-color: #f4f6f8;}
		.ztree li a span.button.switch {visibility:hidden}
		.ztree.showIcon li a span.button.switch {visibility:visible}
		.ztree li a.curSelectedNode {background-color:#FFF;border:0;height:40px;}
		.ztree li span {line-height:40px;}
		.ztree li span.button {margin-top: -2px;}
		.ztree li span.button.switch {width: 18px;height: 18px;}
		
		.ztree li span.button {background-image:url("${ctxStaticLTE}/dist/img/left_menuForOutLook.png");}
...
<body>
	<div id="content" class="row-fluid" style="overflow:auto;">
		<div id="left">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var zNodes=[<c:forEach items="${tjList}" var="tpl">
						{id:'${tpl.id}', pId:'0', name:"${tpl.staname}", liUrl:"${ctx}/common/staSql/commonsta?id=${tpl.id}"},
		            	</c:forEach>];
