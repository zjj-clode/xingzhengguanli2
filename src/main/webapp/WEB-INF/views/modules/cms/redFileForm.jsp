				...
				<div class="box box-info" style="padding-right:20px;padding-top:20px;">
					<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post"
						...
						<label class="col-sm-1 col-sm-1 control-label">其他归属栏目:</label>
							...
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>校教字:</label>
								<div class="col-sm-4">
									<form:input path="schoolWord" htmlEscape="false" maxlength="200" class="form-control required" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>编号:</label>
								<div class="col-sm-4">
									<form:input path="code" htmlEscape="false" maxlength="200" class="form-control required" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>签发:</label>
								<div class="col-sm-4">
									<form:input path="signIssue" htmlEscape="false" maxlength="200" class="form-control required" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>主题词:</label>
								<div class="col-sm-4">
									<form:input path="themeStatement" htmlEscape="false" maxlength="255" class="form-control required" />
								</div>
								<div class="col-sm-5 text-muted">一般三到四个主题词</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>报:</label>
								<div class="col-sm-4">
									<form:input path="report" htmlEscape="false" maxlength="255" class="form-control required" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>发:</label>
								<div class="col-sm-4">
									<form:input path="send" htmlEscape="false" maxlength="255" class="form-control required" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>份数:</label>
								<div class="col-sm-4">
									<form:input path="copies" htmlEscape="false" maxlength="255" class="form-control number required" />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>发表部门:</label>
								<div class="col-sm-4">
									<form:input path="section" htmlEscape="false" maxlength="200" class="form-control required" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1  control-label"><span class="text-red fm">*</span>发表日期:</label>
								<div class="col-sm-4">
									<form:input path="releasetime" htmlEscape="false" maxlength="200" class="form-control required" />
								</div>
								<div class="col-sm-5 text-muted">请填写大写格式，例：二〇一九年五月十七日。</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-1 control-label">附件:</label>
								<div class="col-sm-4">
									<input type="hidden" id="attachment" name="attachment" value="${article.attachment}" />
									<sys:ckfinder input="attachment" type="files" uploadPath="/cms/article" selectMultiple="true" />
								</div>
							</div>
