...
.box {
	...
	background:
		url(${pageContext.request.contextPath}/static/modules/sys/upgrade/maintenance.png)
		no-repeat 0 0;
	position: absolute;
...
<body>
	<div class="box">
		...
		<div class="text">为了能让您访问更快更稳定，同时为您提供更高品质的服务，本系统正在进行升级维护。</div>
		<div class="text">因此目前网站的部分功能不能使用，请稍后再回来。给您造成了不便，请谅解。</div>
	</div>
