...
$.extend($.validator, {
	...
	defaults: {
		...
		onfocusin: function (element, event) {  
           ...
           $('.tip-text').hide();
		    var lab = this.errorsFor(element);
		   // console.log(lab.attr("class"));
		   // console.log(lab.hasClass(this.settings.errorClass));
		    
		    if(lab.hasClass(this.settings.focusClass)){
		    	//console.log(11111);
		    ...
		    //if(!element.hasClass(this.settings.errorClass) && !element.hasClass(this.settings.validClass)){
		    	 var tip = this.errorsFor(element).attr("tip");
		    	 if(tip){
		    	 	this.addWrapper(this.errorsFor(element)).siblings('.tip-text').html(tip).show();
		    //console.log(11);
		    	 	   
		    	 }else{
		    	 	//this.addWrapper(this.errorsFor(element)).css('background-image',"none");
		    	 }
		    //}
		   
		   // console.log(this.errorsFor(element).attr("tip"));
		...
		onfocusout: function (element, event) {  
		    ...
		    this.addWrapper(this.errorsFor(element)).siblings('.tip-text').html('').hide();
		   // console.log(222);
		},
		//TODO 修改
		/*
...
//				var forArr = $(this).attr("for").split(',')
//				if(forArr.indexOf(name)<0){
//					return false
//				}else{
//					return true
//				}
...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    return this.optional(element) || (length == 11 && /^(((1[3456789]{1}))+\d{9})$/.test(value));
}, "请正确填写您的手机号码:13,14,15,16,17,18,19号段");
...
jQuery.validator.addMethod("phone", function(value, element) {     
	var tel = /(^0[1-9]{1}\d{9,10}$)|(^1[3456789]\d{9}$)/g;     
	return this.optional(element) || (tel.test(value));     
