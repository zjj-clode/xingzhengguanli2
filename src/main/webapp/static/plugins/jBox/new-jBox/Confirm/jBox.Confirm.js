...
jQuery(document).ready(function () {
  ...
  new jBoxPlugin('Confirm', {
    ...
    _onCreated: function ()
    {
      ...
      jQuery('<div class="jBox-Confirm-button btn btn-default"/>').html(this.options.cancelButton).click(function () { this.options.cancel && this.options.cancel(); this.close(); }.bind(this)).appendTo(this.footer);
      this.submitButton = jQuery('<div class="jBox-Confirm-button btn btn-primary"/>').html(this.options.confirmButton).appendTo(this.footer);
