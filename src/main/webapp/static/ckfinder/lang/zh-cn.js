...
CKFinder.lang['zh-cn'] =
{
	...
	BasketRemoveConfirmMultiple	: '确认从临时文件夹中移除这些文件 "%1"？', // MISSING
	BasketEmpty			: '临时文件夹为空, 可拖放文件至其中。',
	BasketCopyFilesHere	: '从临时文件夹复制至此',
	BasketMoveFilesHere	: '从临时文件夹移动至此',

	// Global messages
	OperationCompletedSuccess	: '操作成功.<br/>',
	OperationCompletedErrors		: '操作失败.<br/>',
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	MovedFilesNumber		: '移动了 %s 个文件',
	CopiedFilesNumber	: '拷贝了 %s 个文件',
	MoveFailedList		: '文件移动失败:<br />%s',
	CopyFailedList		: '文件拷贝失败:<br />%s',
	...
	ErrorMsg :
	{
		...
		FolderExists	: '目录 %s 已存在。', // MISSING
		FolderNameExists	: '目录已存在。', // MISSING
	...
	Zip :
	{
		extractHereLabel	: '解压到这里', // MISSING
		extractToLabel		: '解压到...', // MISSING
		downloadZipLabel	: '下载zip压缩包', // MISSING
		compressZipLabel	: '添加到zip压缩包', // MISSING
		removeAndExtract	: '移除已存在的文件并解压', // MISSING
		extractAndOverwrite	: '解压覆盖已存在的文件', // MISSING
		extractSuccess		: '文件解压成功' // MISSING
	},
